...
#include <cctype>    // member functions
...
String::String() // defaultt constructor
{
    len = 4;
    str = new char[1];
...
// counts all of the occurrances of given character in string
...
// allows you to join two strings into one
String operator+(const String &st1, const String &st2)
{
    char *result = new char[st1.len + st2.len + 1]; // allocate space
