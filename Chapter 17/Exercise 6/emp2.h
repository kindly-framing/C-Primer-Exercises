...
class abstr_emp
{
  ...
  public:
    ...
    virtual void WriteAll(std::ofstream &file); // writes data to file
    virtual void GetAll(std::ifstream &file);   // reads data from file
    friend std::ostream &
    operator<<(std::ostream &os,
               const abstr_emp &e); // just displays first and last name
